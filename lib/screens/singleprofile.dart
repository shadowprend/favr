                        ...
                        GestureDetector(
                          onTap: () {
                            Clipboard.setData(ClipboardData(
                                text: '0' + widget.data['phonenumber']));
                          },
                          child: Container(
                            child: Column(
                              children: [
                        ...
                        GestureDetector(
                          onTap: () async {
                            try {
                              ...
                              var conversation = await _postCollection
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text(
                              countryCode + widget.data['phonenumber'],
                            ...
                            Text('Mobile',
                                style: TextStyle(
                                    color: getColorFromColorCode('#1d1f23')
                                        .withOpacity(0.5),
                                    fontSize: 13.0)),
                          ],
                        ),
